...
export default function Error({ error, reset }: ErrorPageProps) {
    return (
        <section className="relative z-10 bg-brand-primary">
            <div className="container mx-auto">
                <div className="-mx-4 flex justify-center items-center h-screen">
                    <div className="w-full px-4">
                        <div className="mx-auto max-w-[400px] text-center">
                            <h2
                                className="mb-2 text-[50px] font-bold leading-none text-white sm:text-6xl"
                            >
                                Oops! Error 😵
                            </h2>
                            <h4
                            ...
                            <Button
                                variant={"outline"}
                                onClick={reset}
                                className="inline-block border border-white px-8 py-3 text-center text-base font-semibold text-white transition hover:bg-white hover:text-primary"
                            >
                                Try again
                            </Button>
                        </div>
