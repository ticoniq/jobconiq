...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-20 bg-transparent p-1 text-muted-foreground md:h-10",
      className
    )}
    {...props}
  />
