...
const navigation = [
  ...
  { name: "Company Profile", href: "/company/profile", icon: <Building2 className="h-4 w-4" /> },
  { name: "All Applications", href: "/company/applicants", icon: <Users2 className="h-4 w-4" /> },
  { name: "Job Listing", href: "/company/job-listing", icon: <File className="h-4 w-4" /> },
  { name: "My Schedule", href: "/company/schedule", icon: <CalendarCheck className="h-4 w-4" /> },
];
